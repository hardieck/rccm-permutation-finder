...
public:
    ...
    std::vector<int> * get_sel_add_fixed_shifts(const sspk &position_key); // return fixed shifts, when set

    std::vector<int> * get_sel_add_fixed_opset(const sspk &position_key); // return fixed opset, when set
    ...
    vector<pair<sspk,std::vector<int>>> sel_add_fixed_shift;
    vector<pair<sspk,std::vector<int>>> sel_add_fixed_opset;
